...
<section class="content">
		<form action="<?php echo base_url().'tamu/simpan_tamu'?>" method="post" enctype="multipart/form-data">
					...
					<div class="col-md-6 ">
						<div class="box box-success">
				            ...
				            <div class="box-body">
					            ...
					            <div class="form-group">
					            	<label for="xnamatujuan">Nama Guru Yang Dituju:</label>
				    ...
				    <div class="col-md-6">
				    	<div class="info-box">
							...
							<div class="info-box-content text-center" style="padding:20px;margin: 0 auto">
								...
								<a href="<?php echo base_url('tamu')?>" type="button" class="btn btn-lg btn-default"> Batal</a>
							</div>
						</div>
						<div class="box box-success">
					        	<div class="box-header with-border">
...
<script type="text/javascript">
    ...
    function loadguru(){
		$.ajax({
			url: '<?php echo base_url()?>data_buku_tamu/loadguru',
			type: 'get',
